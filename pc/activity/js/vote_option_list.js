 ...
 *
 */
 data={'type':'list','page':page,'voteId':voteId,'menuId':menuId};
var d=loadData(data); 
pageWrite(d);
...
function add_(id){
    ...
    //var u = url.split("?") 
	if(id==undefined){
	location.href= "./addvote_option.html?voteId="+voteId+"&&menuId="+menuId;
		
	}else{
	location.href= "./addvote_option.html?voteId="+voteId+"&&menuId="+menuId+"&&projectId="+id;
